...
const UpdateUser = (props) => {
    ...
    const { currentUser, crearUsuario, updateCurrentUserInDB} = userContext;
    //UseEffect
    useEffect(() => {
        console.log("Entre al use effect de nuevo contacto");
        fillFormWithDataUser();
        // getRegions();
        // getCompanies();
    ...
    const onCompanyChange = (value) => {
      ...
      const onFinish = (values) => {
        ...
        if(!mostrarMensajeExito){
            ...
            updateCurrentUserInDB(JSON.parse(localStorage.getItem("currentUser")).id, values);
            swal("The user has been updated!", {
                icon: "success",
