...
const NewCompany = (props) => {
    ...
    const {regiones, paisesDeRegion, getRegions, getCountriesByRegion, ciudadesDePais, companias, getCitiesByCountry, getCompanies, fillRegionField, fillCountryField, fillCityField, regionName, country, city, createCompany, deleteCitiesByCountry} = contactContext;
    //UseEffect
    useEffect(() => {
    ...
    return (  
        <Fragment>
            <Header/>
            <h3 className="text-primary text-center">Enter new company data</h3>
